...
const TuesdayMensStandings = () => {
  ...
  const rawStandings = [
    ...
    { team: "The Collective", points: 4, wins: 1, losses: 2, draws: 1, ps: 4, psa: 13, psd: -9, played: 4 },
    ...
    { team: "Big Dawgs FC", points: 6, wins: 2, losses: 3, draws: 0, ps: 5, psa: 6, psd: -1, played: 5 },
