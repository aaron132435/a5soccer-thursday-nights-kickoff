...
const Standings = () => {
  ...
  const rawStandings = [
    { team: "Blue Lock", points: 3, wins: 1, losses: 0, draws: 0, ps: 4, psa: 0, psd: 4, played: 1 },
    { team: "The Paulers", points: 3, wins: 1, losses: 0, draws: 0, ps: 3, psa: 0, psd: 3, played: 1 },
    { team: "Sporting Copa", points: 3, wins: 1, losses: 0, draws: 0, ps: 3, psa: 2, psd: 1, played: 1 },
    { team: "Germantown Impact", points: 0, wins: 0, losses: 1, draws: 0, ps: 2, psa: 3, psd: -1, played: 1 },
    { team: "Real United FC", points: 0, wins: 0, losses: 1, draws: 0, ps: 0, psa: 3, psd: -3, played: 1 },
    { team: "Golden Parachutes", points: 0, wins: 0, losses: 1, draws: 0, ps: 0, psa: 4, psd: -4, played: 1 },
  ];
